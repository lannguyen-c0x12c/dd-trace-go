...
[![Godoc](http://img.shields.io/badge/godoc-reference-blue.svg?style=flat)](https://pkg.go.dev/github.com/lannguyen-c0x12c/dd-trace-go/dd-trace-go.v1)
...
The package [`github.com/lannguyen-c0x12c/dd-trace-go/dd-trace-go.v1/ddtrace/tracer`](https://pkg.go.dev/github.com/lannguyen-c0x12c/dd-trace-go/dd-trace-go.v1/ddtrace/tracer) allows you to trace any piece of your Go code, and commonly used Go libraries can be automatically traced thanks to our out-of-the-box integrations which can be found in the package [`github.com/lannguyen-c0x12c/dd-trace-go/dd-trace-go.v1/ddtrace/contrib`](https://pkg.go.dev/github.com/lannguyen-c0x12c/dd-trace-go/dd-trace-go.v1/contrib).
...
The package [`github.com/lannguyen-c0x12c/dd-trace-go/dd-trace-go.v1/profiler`](https://pkg.go.dev/github.com/lannguyen-c0x12c/dd-trace-go/dd-trace-go.v1/profiler) allows you to periodically collect and send Go profiles to the Datadog API.
...
```bash
go get github.com/lannguyen-c0x12c/dd-trace-go/dd-trace-go.v1/ddtrace/tracer
go get github.com/lannguyen-c0x12c/dd-trace-go/dd-trace-go.v1/profiler
```

Additionally there are many [contrib](./contrib) packages that can be installed to automatically instrument and trace commonly used Go libraries such as [net/http](https://pkg.go.dev/github.com/lannguyen-c0x12c/dd-trace-go/dd-trace-go.v1/contrib/net/http), [gorilla/mux](https://pkg.go.dev/github.com/lannguyen-c0x12c/dd-trace-go/dd-trace-go.v1/contrib/gorilla/mux) or [database/sql](https://pkg.go.dev/github.com/lannguyen-c0x12c/dd-trace-go/dd-trace-go.v1/contrib/database/sql):

```
go get github.com/lannguyen-c0x12c/dd-trace-go/dd-trace-go.v1/contrib/gorilla/mux
```
...
### Documentation
 ...
 - [APM Tracing API](https://pkg.go.dev/github.com/lannguyen-c0x12c/dd-trace-go/dd-trace-go.v1/ddtrace)
